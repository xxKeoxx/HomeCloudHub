/**
 *  AT&T Digital Life Indoor Siren
 *
 ...
 */
metadata {
	definition (name: "AT&T Digital Life Indoor Siren", namespace: "ady624", author: "Adrian Caramaliu", oauth: true) {
		capability "Alarm"
		capability "Battery"
	...
	tiles(scale: 2) {
		standardTile("power-source", "device.power-source", width: 2, height: 2) {
            state "AC", label: 'AC', icon: "st.Office.office6", backgroundColor: "#79b821", canChangeIcon: true, canChangeBackground: true
            state "DC", label: 'DC', icon: "st.Office.office6", backgroundColor: "#ffa81e", canChangeIcon: true, canChangeBackground: true
        }

		standardTile("id", "device.id", decoration: "flat", width: 6, height: 1, ) {
            state "default", label: '${currentValue}', backgroundColor: "#808080", icon:"st.Office.office6"
        }
		...
		standardTile("alarm", "device.alarm", decoration: "flat", width: 2, height: 2) {
            state "off", label: 'OK', icon: "st.Home.home3", backgroundColor: "#79b821"
            state "siren", label: 'ALARM', icon: "st.Home.home3", backgroundColor: "#ff381e"
        }

		main(["power-source"])
        details(['id', 'multi', 'alarm'])
	}
}
